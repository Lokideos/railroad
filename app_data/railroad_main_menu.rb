...
class RailroadUI
  ...
  class << self
          ...
          loop do
            ...
            when 6
              ...
              if chosen_train.train_stopped? && chosen_train.same_type_with_car?(chosen_car)
                ...
                puts "Speed of the train is too high for this operation or
                      car you want to operate with does not exist."
              end
            when 7
              chosen_train = find_train
              ...
              if chosen_train.train_stopped? && chosen_train.same_type_with_car?(chosen_car)
                ...
                puts "Speed of the train is too high for this operation
                      or car you want to operate with does not exist."
              end
            when 8
              chosen_train = find_train
            ...
            when 11
              ...
              Train.all.each { |train_number, _train| puts train_number }
              puts
            when 12
              chosen_train = find_train
              ...
              chosen_car = chosen_train.cars.find { |car| typed_number == car.number }
              ...
              if car.nil?
                ...
                if car.class.to_s == "PassengerCar"
                  puts "Please type in 'take' if you want to take seat in car,
                       'show' if you want to see free places."
                  choice = gets.chomp
                  case choice
                  when "take"
                    car.take_seat
                  ...
                  puts "Please type in 'load' if you want to load something in car,
                       'show' if you want to check free volume"
                  choice = gets.chomp
                  case choice
                  when "load"
        ...
        when 3
          loop do
            ...
            when 3
              ...
              chosen_station = gets.chomp
              chosen_station = chosen_route.stations.find do |station|
                station.name == chosen_station
              end
              if chosen_station.class.to_s == "Station"
                puts "Station has been succesfully deleted from the route."
                chosen_route.stations.each do |_station|
                  chosen_route.remove_station(chosen_station)
                end
              else
                puts "You typed in wrong station names. Please try again."
              end
    ...
    def show_stations_on_route(chosen_route)
